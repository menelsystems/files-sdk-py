"""Stub Netlify adapter — claim this in CLAIM.md and implement."""
...
_NOT_IMPLEMENTED = (
    "files-sdk-netlify is a stub. See packages/files-sdk-netlify/CLAIM.md to claim it."
)


class NetlifyAdapter:
    name: ClassVar[str] = "netlify"
