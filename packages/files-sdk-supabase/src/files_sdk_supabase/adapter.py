"""Stub Supabase adapter — claim this in CLAIM.md and implement."""
...
_NOT_IMPLEMENTED = (
    "files-sdk-supabase is a stub. See packages/files-sdk-supabase/CLAIM.md to claim it."
)


class SupabaseAdapter:
    name: ClassVar[str] = "supabase"
