"""R2 conformance fixtures.

R2 inherits S3-compatible behavior. For conformance we run S3Adapter against
a moto HTTP server; R2-specific endpoint construction and public-URL logic
are tested in test_r2_specific.py.
"""
