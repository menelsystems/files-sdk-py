"""Async DigitalOcean Spaces adapter."""
...
class AsyncDigitalOceanAdapter(AsyncS3Adapter):
    name: ClassVar[str] = "digitalocean-async"
    ...
    def __init__(
        ...
        *,
        ...
        if not resolved_region:
            raise FilesError(
                code="unauthorized",
                message="AsyncDigitalOceanAdapter requires region= or DO_SPACES_REGION env var",
                provider=self.name,
            )
        ...
        kwargs: dict[str, Any] = dict(
            ...
            endpoint_url=_endpoint_override or f"https://{resolved_region}.digitaloceanspaces.com",
        )
