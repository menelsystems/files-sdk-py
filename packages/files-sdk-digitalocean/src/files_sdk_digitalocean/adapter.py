"""Stub DigitalOcean adapter — claim this in CLAIM.md and implement."""
...
_NOT_IMPLEMENTED = (
    "files-sdk-digitalocean is a stub. See packages/files-sdk-digitalocean/CLAIM.md to claim it."
)
